    ...
    with st.container():
        if Audf == True and cudf == True :
            ...
            if dashBoards :
                ...
                All_Achevmentsheet.replace([All_Achevment.columns.values.tolist()] + All_Achevment.values.tolist())
                per_accountsheet.replace([achievement_per_account_df.columns.values.tolist()] + achievement_per_account_df.values.tolist())
                per_per_teamleader.replace([achievement_per_team_leader_df.columns.values.tolist()] + achievement_per_team_leader_df.values.tolist())
                animation_achevment_sh.replace([animation_achevment_df.columns.values.tolist()] + animation_achevment_df.values.tolist())
