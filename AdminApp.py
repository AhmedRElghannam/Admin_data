    ...
    with st.container():
        if Audf == True and cudf == True :
            ...
            if dashBoards :
                ...
                animation_achevment_sh.update([animation_achevment_df.columns.values.tolist()] + animation_achevment_df.values.tolist())
...
if selected_menu == 'Claim' :
    ...
    with st.container():
        ...
        with Claim:
            claim_path = st.file_uploader('Upload card request CSV',accept_multiple_files=False)
